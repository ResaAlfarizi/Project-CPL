...
// Komponen utama Matrix Hak Akses (untuk digunakan dalam layout)
      ...
      >
        <div className="flex items-center gap-6 justify-center flex-wrap">
          <div className="flex items-center gap-2">
            ...
            <span
              style={{ color: '#D8DFE9', fontSize: '13px', fontFamily: 'Urbanist, sans-serif' }}
            >
              Read (Baca)
            </span>
          </div>
